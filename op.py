...
path = "C:\\Users\\alvar\\Desktop\\datos.xlsx"
#Average number of opcodes per contract
avg = 0
#Total number of contracts
total = 0
#Opcodes per contract
con = 0
#Unknown Opcodes
error = 0
...
#This function calculates the average number of opcodes (instructions) in a total of x contracts
def calculate(number):
  global total
  global error
  number = number / total
  msg = "The average number of opcodes in a total of {} contracts is {} without counting the {} unknown opcode"
  print(msg.format(total, number, error))
